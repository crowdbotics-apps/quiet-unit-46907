"""
Django settings for quiet_unit_46907 project.
...
ROOT_URLCONF = 'quiet_unit_46907.urls'
...
WSGI_APPLICATION = 'quiet_unit_46907.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_unit_46907 API",
    "DESCRIPTION": "API documentation for quiet_unit_46907 App",
    "VERSION": "v1",
}
